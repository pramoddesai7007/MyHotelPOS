...
const Coupon = () => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "http://103.159.85.246:5000/api/counterHotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `http://103.159.85.246:5000/api/counterHotel/getHotel/${defaultHotelId}`
          );
  ...
  const handlePrintBill = async () => {
    try {
      const [couponResponse, counterResponse] = await Promise.all([
        axios.get("http://103.159.85.246:5000/api/coupon/coupon/latest"),

        axios.get("http://103.159.85.246:5000/api/counter"),
      ]);
  ...
  //       `http://103.159.85.246:5000/api/counterHotel/getHotel/661e0d39092937c54273c154`
  ...
  //       "http://103.159.85.246:5000/api/coupon/billCouponOrder",
  //       saveData
  //     );
  ...
  //       `http://103.159.85.246:5000/api/coupon/orderNumber/${orderNumber}`
  //     );
  ...
  useEffect(() => {
    axios
      .get("http://103.159.85.246:5000/api/counter")
      .then((response) => {
    ...
    axios
      .get("http://103.159.85.246:5000/api/table/tables")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`http://103.159.85.246:5000/api/counter/${selectedCategory._id}`)
        .then((response) => {
  ...
  const printCoupon = async () => {
    try {
      ...
      const countersResponse = await axios.get(
        "http://103.159.85.246:5000/api/counter"
      );
      ...
      const latestCouponResponse = await axios.get(
        "http://103.159.85.246:5000/api/coupon/coupon/latest"
      );
                        ...
                        <div>
                          ...
                          <div className="justify-center flex">
                            <img
                              src={
                                product.imageUrl
                                  ? `http://103.159.85.246:5000/${product.imageUrl}`
                                  : `/tray.png`
                              }
