...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`http://103.159.85.246:5000/api/table/tables/${tableId}`);
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('http://103.159.85.246:5000/api/table/tables');
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `http://103.159.85.246:5000/api/table/${sectionId}/tables`,
                { numberOfTables },
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('http://103.159.85.246:5000/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `http://103.159.85.246:5000/api/table/tables/${tableToDelete._id}`
            );
