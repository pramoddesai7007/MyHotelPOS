...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("http://103.159.85.246:5000/api/purchase/purchases");
        ...
        const vendorsResponse = await axios.get("http://103.159.85.246:5000/api/supplier/suppliers");
