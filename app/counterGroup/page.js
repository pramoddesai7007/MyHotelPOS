...
const CounterGroupMenu = () => {
  ...
  useEffect(() => {
    const fetchMainCategories = async () => {
      try {
        setLoading(true);
        const response = await axios.get("http://103.159.85.246:5000/api/main");
  ...
  useEffect(() => {
    const fetchCounterCategories = async () => {
      try {
        setLoading(true);
        const response = await axios.get("http://103.159.85.246:5000/api/counter");
  ...
  const handleAddMenusToCategory = async () => {
    try {
      const response = await axios.post(
        `http://103.159.85.246:5000/api/counter/${selectedCounterCategory}/assignmenus`,
        {
  ...
  const assignMainCategoryToCounter = async () => {
    try {
      ...
      const response = await axios.post(
        `http://103.159.85.246:5000/api/counter/${selectedCounterCategory}/assignmaincategory`,
        {
          mainCategory: {
  ...
  const fetchAllMenus = async () => {
    try {
      const response = await axios.get(
        "http://103.159.85.246:5000/api/menu/menus/list"
      );
    ...
    const fetchData = async () => {
      try {
        ...
        const mainCategoriesResponse = await axios.get(
          "http://103.159.85.246:5000/api/main"
        );
  ...
  const fetchMenusForCounterCategory = async (counterCategoryId) => {
    try {
      ...
      const response = await axios.get(
        `http://103.159.85.246:5000/api/counter/${counterCategoryId}/menus`
      );
  ...
  const handleDeleteMenus = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `http://103.159.85.246:5000/api/counter/${selectedCounterCategory}/removemenus`,
        {
