...
const Billing = ({ tableId, acPercentage }) => {
  ...
  const handleResetTable = async (sectionName, mainTableName) => {
    try {
      ...
      const tableResponse = await axios.get(`http://103.159.85.246:5000/api/table/tables/bySection/${sectionName}/${mainTableName}`);
      ...
      const sectionResponse = await axios.get(`http://103.159.85.246:5000/api/table/section/byName/${sectionName}`);
      ...
      const response = await axios.put(`http://103.159.85.246:5000/api/table/${sectionId}/${mainTableId}/reset-subtables`);
  ...
  const handleShowSubmit = async (sectionName, mainTableName, numberOfSubtablesToShow) => {
    try {
      ...
      const response = await axios.put(`http://103.159.85.246:5000/api/table/${sectionId}/${mainTableId}/show-subtables`, {
  ...
  const handleCancelKOT = async () => {
    try {
      ...
      await axios.delete(`http://103.159.85.246:5000/api/kot/${tableId}`, {
    ...
    const fetchTastes = async () => {
      try {
        const response = await axios.get(
          "http://103.159.85.246:5000/api/taste/tastes"
        );
  ...
  const fetchWaitersList = async () => {
    try {
      const response = await axios.get("http://103.159.85.246:5000/api/waiter");
  ...
  useEffect(() => {
    const fetchGreetings = async () => {
      try {
        const response = await axios.get(
          "http://103.159.85.246:5000/api/greet/greet"
        );
  ...
  useEffect(() => {
    ...
    const fetchNextOrderNumber = async () => {
      try {
        const response = await axios.get(
          "http://103.159.85.246:5000/api/order/get-next-order-number"
        );
  ...
  const fetchLastAllOrders = async () => {
    try {
      const ordersResponse = await axios.get(
        "http://103.159.85.246:5000/api/order/latest-orders"
      );
      ...
      const tableNamesPromises = orders.map(async (order) => {
        const tableResponse = await axios.get(
          `http://103.159.85.246:5000/api/table/tables/${order.tableId}`
        );
  ...
  const saveBill = async () => {
    try {
      ...
      const existingBillResponse = await axios.get(
        `http://103.159.85.246:5000/api/order/order/${tableId}`
      );
      ...
      if (existingBill && existingBill.length > 0) {
        ...
        const updateResponse = await axios.patch(
          `http://103.159.85.246:5000/api/order/update-order-by-id/${orderIdToUpdate}`,
          orderData
        );
  ...
  localStorage.removeItem('selectedSectionName');
      ...
      const KOTResponse = await axios.post(
        `http://103.159.85.246:5000/api/kot/kotOrder/${tableId}`,
        kotData
      );
  ...
  const saveKot = async () => {
    try {
      ...
      const existingKOTResponse = await axios.get(
        `http://103.159.85.246:5000/api/kot/kot/${tableId}`
      );
  ...
  const handlePrintBill = async () => {
    try {
      ...
      if (temporaryOrderIndex !== -1) {
        ...
        await axios.patch(`http://103.159.85.246:5000/api/kot/kot/settle/${tableId}`);
...
<script>
  ...
  useEffect(() => {
    ...
    // Fetch categories
    axios
      .get("http://103.159.85.246:5000/api/main/hide")
      .then((response) => {
    ...
    // Fetch products
    axios
      .get("http://103.159.85.246:5000/api/menu/menus/list")
      .then((response) => {
    ...
    // if (tableId) {
    //   axios
    //     .get(`http://103.159.85.246:5000/api/table/tables/${tableId}`)
    //     .then((response) => {
    ...
    if (tableId) {
      axios
        ...
        .then((response) => {
          ...
          axios
            .get(`http://103.159.85.246:5000/api/order/savedBills/${tableId}`)
            .then((response) => {
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      axios
        .get(`http://103.159.85.246:5000/api/menu/${selectedCategory._id}`)
        .then((response) => {
          // console.log(response.data);
          const menusArray = response.data || []; // Ensure menus is an array
          setMenus(menusArray);
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === null) {
      ...
      // Fetch menus based on the selected category
      axios
        .get(`http://103.159.85.246:5000/api/menu/menulist/${category._id}`)
        .then((response) => {
          setMenus(response.data);
        })
        .catch((error) => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "http://103.159.85.246:5000/api/hotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `http://103.159.85.246:5000/api/hotel/get/${defaultHotelId}`
          );
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      const response = await axios.patch(
        `http://103.159.85.246:5000/api/table/tables/${editTable._id}`,
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    ...
    const fetchSections = async () => {
      try {
        const sectionsResponse = await axios.get('http://103.159.85.246:5000/api/section');
  ...
  //   try {
  //     const response = await axios.patch('http://103.159.85.246:5000/api/order/mergeTables', {
  //       destinationTableId,
  //       sourceTableId,
  //     });
  ...
  const handleMergeTables = async (sectionId, destinationTableName, sourceTableName) => {
    try {
      ...
      const destinationTableResponse = await axios.get(`http://103.159.85.246:5000/api/table/table/bySectionAndName/${sectionId}/${destinationTableName}`);
      ...
      const sourceTableResponse = await axios.get(`http://103.159.85.246:5000/api/table/table/bySectionAndName/${sectionId}/${sourceTableName}`);
                    ...
                    >
                      <div>
                        ...
                        <div className="justify-center flex">
                          <img
                            src={product.imageUrl ? `http://103.159.85.246:5000/${product.imageUrl}` : `/tray.png`}
