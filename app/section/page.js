...
const Section = () => {
  ...
  useEffect(() => {
    ...
    const fetchDefaultSectionName = async () => {
      try {
        const response = await axios.get("http://103.159.85.246:5000/api/section/section/default");
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("http://103.159.85.246:5000/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `http://103.159.85.246:5000/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `http://103.159.85.246:5000/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "http://103.159.85.246:5000/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "http://103.159.85.246:5000/api/section/create",
        formData,
        {
          headers: {
