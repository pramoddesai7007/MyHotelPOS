...
const CounterList = () => {
  ...
  const updateCounter = async () => {
    try {
      const response = await axios.patch(
        `http://103.159.85.246:5000/api/counter/${editCounter._id}`,
        {
  ...
  const addCounter = async () => {
    try {
      const response = await axios.post("http://103.159.85.246:5000/api/counter", {
  ...
  const deleteCounter = async () => {
    try {
      const response = await axios.delete(
        `http://103.159.85.246:5000/api/counter/${counterToDeleteId}`
      );
